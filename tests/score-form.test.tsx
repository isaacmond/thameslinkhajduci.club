...
const fixture = (over: Partial<SubmitFixture>): SubmitFixture => ({ id: "s8-gw3", label: "Tue 15 Sept · GW3 vs TMHLR F.C.", seasonId: "S8", gw: 3, opponent: "TMHLR F.C.", date: "2026-09-15", played: false, ourGoals: null, theirGoals: null, lineup: [], expected: [], scorers: {}, assists: {}, motm: null, ...over });
