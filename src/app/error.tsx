...
export default function Error({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <div className="card-solid pitch mx-auto max-w-2xl px-6 py-14 text-center animate-rise">
      ...
      <p className="mx-auto mt-3 max-w-md text-ash">Something went wrong reading the spreadsheet, or rendering what came back. This is usually Google having a moment, occasionally us.</p>
      ...
      <div className="mt-6 flex flex-wrap justify-center gap-3">
        ...
        <a href={SHEET_URL} target="_blank" rel="noopener noreferrer" className="focus-ring rounded-lg border border-white/15 px-4 py-2.5 font-semibold text-cream hover:bg-white/10">Open the sheet ↗</a>
      </div>
    </div>
  );
}
