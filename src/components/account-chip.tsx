...
export function AccountChip({ className }: { className?: string }) {
  ...
  return (
    <span className={clsx("inline-flex items-center gap-2", className)}>
      {me.admin && <Link href="/admin" className="focus-ring hidden rounded-md px-2 py-1.5 text-sm font-medium text-ash transition-colors hover:text-cream sm:inline">Admin</Link>}
