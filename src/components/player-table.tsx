...
const COLS: { key: Key; label: string; title?: string; num?: boolean }[] = [
  ...
  { key: "goalsPerGame", label: "G/G", title: "Goals per game (games with scorers logged)", num: true }, { key: "assistsPerGame", label: "A/G", title: "Assists per game (games with assists logged)", num: true }, { key: "motm", label: "MOTM", title: "Man of the match awards", num: true },
